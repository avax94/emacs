...
(use-package org
  ...
  (defun org-scratch-search ()
    (interactive)
    (let* ((org-agenda-files (list avax-org-mode-scratch-file)))
      (org-tags-view)))
